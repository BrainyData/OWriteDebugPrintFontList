...
This debug library is used for producing three PDF files that list installed fonts in various ways for the purpose of investigating font related issues with OWrite. It specifically produces a list of Font Family names, their typefaces and Omnis encoded font names for each typeface. It also shows how to produce outline trees with PDFDevice and system font table notation.
